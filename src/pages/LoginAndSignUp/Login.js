    ...
    return (
        <div className='h-screen w-10/12 md:w-8/12 lg:w-6/12 mx-auto flex justify-center items-center'>
            <div className='bg-amber-100 p-10 rounded-lg'>
                ...
                <p className='text-center text-slate-600'>Don't have an account ? <Link to='/signup' className='font-bold text-sky-700'>Register</Link></p>
                <form onSubmit={handleSubmit(onSubmit)} className='mt-4'>
                    ...
                    <button type='submit' className="btn btn-accent w-full mt-4">Login Now</button>
                </form>
